			...
			<tr>
				...
				<?php 
					...
					if (isset($monthnum))
					{
						...
						echo "<th colspan='7' bgcolor='#424242'><font color='#FFFFFF' style='font-family: calibri; font-size:12pt''>".$months[(int)$week]."</font></th>";
					...
					elseif (isset($weeknum))
					{
						...
						echo "<th colspan='7' bgcolor='#424242'><font color='#FFFFFF' style='font-family: calibri; font-size:12pt''>W".$week[0]."</font></th>";
				...
				<tr>
				<th bgcolor="#A4A4A4" width="9%"><font color="#FFFFFF" style="font-size:20pt'"><a style= "color:#FFFFFF" onclick='selectkpitriage(this)'>KPI</a></font></th>
				<th bgcolor="#B23AEE" width="9%"><font color="#FFFFFF" style="font-size:20pt'"><a style= "color:#FFFFFF" onclick='selectkpitriage(this)'>OMR</a></font></th>
				<th bgcolor="#66CDAA" width="9%"><font color="#FFFFFF" style="font-size:20pt'"><a style= "color:#FFFFFF" onclick='selectkpitriage(this)'>TX/OMR</a></font></th>
				<th bgcolor="#2E9AFE" width="9%"><font color="#FFFFFF" style="font-size:20pt'"><a style= "color:#FFFFFF" onclick='selectkpitriage(this)'>OTM</a></font></th>
				<th bgcolor="#EEDC82" width="9%"><font color="#FFFFFF" style="font-size:20pt'"><a style= "color:#FFFFFF" onclick='selectkpitriage(this)'>CAPACITY</a></font></th>
				<th bgcolor="#FE642E" width="9%"><font color="#FFFFFF" style="font-size:20pt'"><a style= "color:#FFFFFF" onclick='selectkpitriage(this)'>PLAN/ENG RF</a></font></th>
				<th bgcolor="#000000" width="9%"><font color="#FFFFFF" style="font-size:20pt'">AREA/STATUS</font></th>
