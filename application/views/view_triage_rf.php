			...
			<tr>
				...
				<?php 
					...
					if (isset($monthnum))
					{
						...
						echo "<th colspan='12' bgcolor='#424242'><font color='#FFFFFF' style='font-family: calibri; font-size:12pt''>".$months[(int)$week]."</font></th>";
					...
					elseif (isset($weeknum))
					{
						...
						echo "<th colspan='12' bgcolor='#424242'><font color='#FFFFFF' style='font-family: calibri; font-size:12pt''>W".$week."</font></th>";
				...
				<th bgcolor="#FE642E"><div class='vrt_triage'><font color="#FFFFFF" style="font-size:20pt'">BOARD FOUND<font></div></th>
				<th bgcolor="#FE642E"><div class='vrt_triage'><font color="#FFFFFF" style="font-size:20pt'">BOARD CHECK<font></div></th>
				<th bgcolor="#FE642E"><div class='vrt_triage'><font color="#FFFFFF" style="font-size:20pt'">NP ACTION FOUND<font></div></th>
				<th bgcolor="#FE642E"><div class='vrt_triage'><font color="#FFFFFF" style="font-size:20pt'">NP SOLUTION<font></div></th>
				<th bgcolor="#FE642E"><div class='vrt_triage'><font color="#FFFFFF" style="font-size:20pt'">NOTE<font></div></th>
		...
		<tbody>	
			...
			$bggood = "#FFFFFF";
				...
				foreach($triage_week as $row)
				{
					...
					echo "<td bgcolor='#FFFFFF'>".$board_found."</font></td>";
					echo "<td bgcolor='".($status_board == 'OK'?$bggood:$bgbad)."'><font style='font-family: calibri; font-size:12pt' color='".($status_board == 'OK'?$good:$bad)."'>".$status_board."</font></td>";
					echo "<td bgcolor='".($np_action_found == 'Yes'?$bgbad:$bggood)."'><font style='font-family: calibri; font-size:12pt' color='".($np_action_found == 'Yes'?$bad:$good)."'>".$np_action_found."</font></td>";
					echo "<td bgcolor='#FFFFFF'>".$np_solution."</font></td>";
					echo "<td bgcolor='#FFFFFF'>".$note_rf."</font></td>";
