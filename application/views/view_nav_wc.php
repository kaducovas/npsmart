...
#echo count($cells);
                ...
                <ul class="nav navbar-nav" id="mainMenu">
                     <li id="menuItemnqi" class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="disabled"><a href="#">AMX Radar</a></li>
                            <li class="disabled"><a href="#">Unbalance</a></li>
                        </ul>
                    </li>
                    ...
                    <li id="menuItemwaf" class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
							<li class="disabled"><a href="#">Baseline NodeB Audit</a></li>
	 ...
	 <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">UMTS<span class="glyphicon glyphicon-phone pull-left" style="margin-top:2px;margin-right:4px;"></span><span class="caret"></span></a>
		<ul class="dropdown-menu" role="menu">
	 	 	 ...
	 	 	 <li class="disabled">
	 <a style="text-transform: capitalize" href="#" aria-expanded="false"><?php echo $reportagg ?> <span class="glyphicon glyphicon-calendar pull-left" style="margin-top:2px;margin-right:4px;"></span><span id="caretOptions1" class="caret"></span></a>

     </li>
 
    <li class="disabled">
        <a href="#" aria-expanded="false"><span id="spDate"><?php echo $calendarinfo;?></span> <span class="glyphicon glyphicon-calendar pull-left" style="margin-top:2px;margin-right:4px;"></span><span id="caretOptions1" class="caret"></span></a>
    </li>

                    <li class="disabled">
                        <a href="#" aria-expanded="false"><span id="spOptions"><?php echo $reportnename;?></span> <span class="glyphicon glyphicon-th-list pull-left" style="margin-top:2px;margin-right:4px;"></span><span id="caretOptions" class="caret"></span></a>
