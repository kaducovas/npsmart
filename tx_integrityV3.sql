...
where datetime between '2017-07-09' and '2017-07-16' ----acelerar
) atm 
left join 
...
and ip.datetime between '2017-07-09' and '2017-07-16' ----acelerar
) tx_ip
...
and tx_ip.datetime between '2017-07-09' and '2017-07-16'
) t
